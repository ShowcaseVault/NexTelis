...
// Release signing credentials live outside the repo (see android/.gitignore).
// Absent on machines that only build debug — the release buildType then falls
// back to unsigned rather than failing configuration.
